    ...
    def overall_operation(self, config):
        ...
        for epoch in range(args.epoch):
            ...
            for batch_idx in range(num_batches):
                ...
                loss = ((train_result['regLoss'] * args.reg) / num_batches) + (train_result['ssl_loss_S']+train_result['ssl_loss_T']) * args.ssl_beta + \
                            (train_result['metaregloss_1']+train_result['metaregloss_2']) * args.metareg

                total_loss = 0.6 * train_result['DCCloss'] + 0.4 * loss
                total_loss = 0.8 * train_result['DCCloss'] + 0.2 * loss
                ...
                # epoch_loss2 += total_loss.item() / num_batches
                # 更新进度条
            ...
            print('%s: HR@5 %f NDCG@5 %f' % (
                args.domain_S, ret_1[0] / user_count_1, ret_1[1] / user_count_1))
            print('Best for %s: HR@5 %f NDCG@5 %f' % (
            ...
            print('Best HitRatio for %s: HR@5 %f NDCG@5 %f'
